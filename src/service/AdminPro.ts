...
export async function crearProducto(producto: any) {
  try {
    const response = await axios.post(`${BASE_URL}/pedidosG`, producto);
    return response.data;
  } catch (error: any) {
...
export async function actualizarProducto(id: number, producto: any) {
  try {
    const response = await axios.put(`${BASE_URL}/pedidos/${id}`, producto);
    return response.data;
  } catch (error: any) {
...
export async function eliminarProducto(id: number) {
  try {
    const response = await axios.delete(`${BASE_URL}/pedidos/${id}`);
    return response.data;
  } catch (error: any) {
